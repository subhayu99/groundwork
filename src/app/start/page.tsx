    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-1 max-w-6xl mx-auto px-5 md:px-8 py-12 w-full">
        ...
        <p className="text-[var(--text-muted)] mb-8 max-w-2xl leading-relaxed">
          ...
          principles — no memorizing. Your answers decide{" "}
          <strong className="text-[var(--text)]">where you start</strong> and{" "}
          <strong className="text-[var(--text)]">how every lesson is pitched</strong> — watch the
          map below adapt as you answer.
        </p>
        <OnboardingQuiz />
      </main>
    </div>
