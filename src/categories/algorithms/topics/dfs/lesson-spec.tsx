  ...
  beats: [
    {
      ...
      panels: [
        {
          ...
          body: reg({
            ...
            <>
              ...
              is <strong>G</strong> (bottom-right). Filled cells are walls you
              can&rsquo;t pass. You may step one cell up, down, left or right.
            ...
            intuitive: (
              <>
                ...
                step at a time: up, down, left or right. Your eye sees the
      ...
      detail: (
        <>
          <p>Picture a small board, 5 squares wide and 5 squares tall. You begin in the top-left square, marked <strong>S</strong> for start, and you want to reach the bottom-right square, marked <strong>G</strong> for goal. Some squares are <strong>walls</strong>: solid blocks you cannot walk through. From any square you may step one square at a time: up, down, left, or right (never diagonally). The question is simply: <strong>is there a way through?</strong></p>
    ...
    },
    {
      ...
      panels: [
        {
          ...
          body: (
            <>
              The blind way, ignoring walls and never reusing what you
              learned, lists every sequence of moves and tests each: four
      ...
      detail: (
        <>
          ...
          <p>Two cheap rules cut it down to size. First, <strong>never step onto a square you&rsquo;ve already visited.</strong> If you&rsquo;ve stood there before, you already explored everything reachable from it, so going again teaches you nothing new. Second, <strong>turn around when you&rsquo;re stuck:</strong> if every neighbour of your square is a wall or already-visited, this square leads nowhere, so retreat to where you came from and try a different direction there.</p>
          <p>Those two rules, mark-as-visited and back-up-when-stuck, are the entire idea. Instead of a million blind guesses, you walk the maze deliberately, touching each open square at most once.</p>
        </>
      ),
      codeLabels: [],
    },
      ...
      panels: [
        {
          ...
          body: (
            <>
              Your turn. Click a lit neighbour to step into it; each cell
        ...
        },
        {
          ...
          body: (
            <>
              ...
              the maze from any cell is a smaller copy of the same question:{" "}
    ...
    },
    {
      ...
      takeaway: reg({
        base: "The rule: mark visited, then ask each neighbour the same question, using a function that calls itself (recursion).",
      ...
      panels: [
        {
          ...
          body: reg({
            ...
            <>
              ...
              same question. Out of neighbours: return nothing, and the caller tries
            ...
            intuitive: (
              <>
                ...
                Done: hand the trail back. Standing anywhere else? Mark the square
                ...
                say no too, and whoever asked you tries their next direction. A rule
      ...
      detail: reg({
        ...
        <>
          ...
          <p><strong>You&rsquo;re standing on the goal.</strong> Done: hand back the trail, which is the route that got you here.</p>
          <p><strong>You&rsquo;re on any other square.</strong> First mark it visited so you never come back. Then, for each neighbour in turn: if it&rsquo;s open (not a wall) and not yet visited, ask it the very same question by calling <code>find_path_from(neighbour, trail + neighbour)</code>. If that call hands back a trail, you&rsquo;re finished, so pass it straight up. If it hands back nothing, move on and try the next neighbour.</p>
          ...
          <div className="mt-1 p-3 rounded-lg bg-[var(--accent-soft)] border border-[var(--accent-line)] text-[var(--text)]"><strong>The principle, decomposition:</strong> the big maze is solved by solving each smaller maze that starts from a neighbour. Once you see that, the recursive rule writes itself.</div>
        </>
      ),
        rigorous: (
          <>
      ...
      panels: [
        {
          ...
          body: reg({
            base: (
            <>
              Work grows as <strong>O(cells + connections)</strong>, here a few dozen
              ...
              <span className="text-[var(--diff-easy)]">is</span> that stack: a
              20-cell detour stacks 20 deep before retreating.
            </>
          ),
            intuitive: (
              <>
                Watch the <em>visited</em> number once it runs: it only climbs.
                ...
                the connections between them, written{" "}
            ...
            rigorous: (
              <>
                ...
                at most four neighbours; the playback&rsquo;s visited counter is
      ...
      panels: [
        {
          ...
          body: (
            <>
              ...
              a folder, a friend, a webpage. The same walk crawls a website,
      ...
      panels: [
        {
          ...
          body: reg({
            base: (
            <>
              That&rsquo;s the name. <em>Depth-first</em> because at each step
              ...
              and when the natural answer calls itself.
            </>
          ),
            intuitive: (
              <>
                The name: <strong>Depth-First Search</strong>. <em>Depth-first</em>{" "}
                ...
                &ldquo;try it, undo it, try the next&rdquo;: reach for this walk.
            ...
            rigorous: (
              <>
                <strong>Depth-First Search</strong>: recursion over a graph;
      ...
      detail: reg({
        ...
        <>
          ...
          <ul>
            ...
            <li>&ldquo;Visit every connected thing&rdquo;: count the separate clusters, or fill in a whole region.</li>
            <li>&ldquo;Try a choice, undo it, try the next&rdquo;: puzzles like sudoku or placing queens on a chessboard.</li>
        ...
        rigorous: (
          <>
            ...
            <div className="mt-1 p-3 rounded-lg bg-[var(--accent-soft)] border border-[var(--accent-line)] text-[var(--text)]">
              <strong>Idea 4 of 7, decomposition:</strong> &ldquo;reach G from here&rdquo; decomposes into &ldquo;reach G from a neighbour&rdquo; on the unvisited remainder: recursion pointed at a space. Backtracking, later in the track, is this exact walk over a space of choices, plus pruning.
            </div>
          </>
        ),
      }),
